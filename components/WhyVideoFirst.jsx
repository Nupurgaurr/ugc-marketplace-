...
/**
 * The report calls hover-to-preview browsing an under-served gap. Rather than
 * describing it, this section lets a client flip the same four creators between
 * the way every other marketplace shows them and the way this one does.
 */
export default function WhyVideoFirst({ creators }) {
    ...
    <section className="section section--ruled">
      <div className={`container ${styles.split}`}>
        <div className={styles.splitCopy}>
          <Eyebrow>Why video-first</Eyebrow>
          ...
          <p className="lede" style={{ marginTop: '1.4rem' }}>
            ...
            good — four clicks and four back-buttons to reject four creators. Flip the
                  ...
                  <div className={styles.row} key={creator.id}>
                    ...
                    <div>
                      ...
                      <p className={styles.rowMeta}>
                        {creator.category} · {creator.portfolioCount} videos
                      </p>
                    </div>
